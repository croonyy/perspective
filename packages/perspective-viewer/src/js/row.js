    ...
    connectedCallback() {
        ...
        li.addEventListener('dragstart', ev => {
            if (this.hasAttribute('filter')) {
                ...
                ev.dataTransfer.setData("text", JSON.stringify([this.getAttribute('name'), operator, operand, this.getAttribute('type')]));
            } else {
                ev.dataTransfer.setData("text", JSON.stringify([this.getAttribute('name'), perspective.FILTER_DEFAULTS[this.getAttribute('type')], undefined, this.getAttribute('type')]));
            }
